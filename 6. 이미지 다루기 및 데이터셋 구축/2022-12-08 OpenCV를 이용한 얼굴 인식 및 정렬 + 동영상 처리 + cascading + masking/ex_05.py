...
# different weights are addded to the image to give a feeling of blending
# 1.0 == 1.
def blend_images(image, final_image, alpha=0.7, beta=1.0, gamma=0.0):
...
circles = cv2.HoughCircles(blurredImage, method=cv2.HOUGH_GRADIENT,
