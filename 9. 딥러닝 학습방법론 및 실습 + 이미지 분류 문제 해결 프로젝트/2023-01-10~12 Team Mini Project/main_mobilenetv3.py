...
from custom_data import myCustomdata
...
train_dataset = myCustomdata('./dataset/train', transform=train_transform)
val_dataset = myCustomdata('./dataset/val', transform=val_transform)
test_dataset = myCustomdata('./dataset/test', transform=val_transform)
...
'''
# 3. Data loader-----------------------------------------------------------
train_loader = DataLoader(train_dataset, batch_size=80, shuffle=True, num_workers=2, pin_memory=True)
val_loader = DataLoader(val_dataset, batch_size=80, shuffle=False, num_workers=2, pin_memory=True)
