...
def main():    
    ...
    model7 = models.MobileNetV2()
    model7 = models.__dict__["mobilenet_v2"](pretrained= True)
    model7.classifier[1] = nn.Linear(in_features=1280, out_features=2)
    model7.to(device)
