...
train_dataset = my_dataset("./data04/train/", transform=train_aug)
val_dataset = my_dataset("./data04/test/" ,transform=val_aug)

train_loader = DataLoader(train_dataset, batch_size=68, shuffle=True)
val_loader = DataLoader(val_dataset, batch_size=68, shuffle=False)
...
optimizer = torch.optim.AdamW(finetune_net.parameters(), lr=0.001, weight_decay=0.0005)
